          ...
          {/* Show this if user has not yet created tasks */}
          {
            isInitialized ? (
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <button className="bg-[#336AE0] rounded-md flex items-center justify-center gap-2 px-6 py-3 cursor-pointer hover:bg-[#225DDC] transition-all duration-100 ease text-sm mt-3" onClick={handleIsInitialized}>
                  <GoPlus size={20} />
                  Add Task
                </button>
              </div>
